...
class ESLevent {
	...
	public function __construct($type_or_wrap_me_or_me,$subclass_name_or_free_me=null) {
	...
	public function getHeader($header_name,$idx=-1) {
	...
	public function pushHeader($header_name,$value) {
		return ESLevent_pushHeader($this->_cPtr,$header_name,$value);
	}

	public function unshiftHeader($header_name,$value) {
...
class ESLconnection {
	...
	public function __construct($host_or_socket,$port=null,$user_or_password=null,$password=null) {
	...
	public function bgapi($cmd,$arg=null,$job_uuid=null) {
		switch (func_num_args()) {
	...
	public function sendEvent($send_me) {
	...
	public function sendMSG($send_me,$uuid=null) {
		switch (func_num_args()) {
	...
	public function recvEventTimed($ms) {
	...
	public function events($etype,$value) {
		return ESLconnection_events($this->_cPtr,$etype,$value);
	}

	public function execute($app,$arg=null,$uuid=null) {
		switch (func_num_args()) {
	...
	public function executeAsync($app,$arg=null,$uuid=null) {
		switch (func_num_args()) {
	...
	public function setAsyncExecute($val) {
		return ESLconnection_setAsyncExecute($this->_cPtr,$val);
	}

	public function setEventLock($val) {
